...
{	
	...
	if ($tcomp ==  119 ||  $tcomp ==  120 || $tcomp == 121 || $tcomp == 135) {
		...
		if ($tcomp == 115 || $tcomp == 116 || $tcomp == 117 || $tcomp == 125 || $tcomp == 126 || $tcomp == 127 || $tcomp == 133 || $tcomp == 134) {
			$tc = "FC-";
			$signo = 1;
		} else 
	...
	if ($estado == 'S') {
		...
		$debito = 0.00;
		$credito = $netocbterel;
        $query_cabrecibo = sprintf("SELECT * FROM cabrecibo WHERE ncomp = %s", $ncomp_recibo);
