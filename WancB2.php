...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
    ...
    //Cabecera
    $CbteTipo = 8; // N Cred B - Ver - AfipWsfev1::FEParamGetTiposCbte()
    $PtoVta = 2;
...
// aca termina envio a afip y pedido
...
if ($sigo_y_grabo == 1 && $todo_ok ==1) {
	...
	if (isset($_POST['concepto']) && GetSQLValueString($_POST['concepto'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
		    $query_mascara2 = "SELECT * FROM series  WHERE series.codnum='53'";
            ...
            if (GetSQLValueString($_POST['tcbterel'], "int") == 7)
                $mascara2 = substr($_POST['descripcion'],2,60)." Apl.Nd. ".$mascara2;
            else
                $mascara2 = substr($_POST['descripcion'],2,60)." Apl.Fc. ".$mascara2;
            $mascara2 = "'".$mascara2."'";
            //echo $mascara2;
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, nreng, codrem, concafac, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       NC_B2, //GetSQLValueString($_POST['tcomp'], "int"),
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 1;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR GRABANDO R 1  ".$insertSQL." -- ");
  			if (GetSQLValueString($_POST['concepto'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe'], "int");
            }
		}
	}
	if (isset($_POST['concepto1']) && GetSQLValueString($_POST['concepto1'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, nreng, codrem, concafac, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
					   ...
					   GetSQLValueString(substr($_POST['descripcion1'],3,80), "text"),
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 2;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR GRABANDO R 2");
  			if (GetSQLValueString($_POST['concepto1'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe1'], "int");
            }
		}
	}
	if (isset($_POST['concepto2']) && GetSQLValueString($_POST['concepto2'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, nreng, codrem, concafac, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(substr($_POST['descripcion2'],3,80), "text"),
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 3;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR GRABANDO R 3");
  			if (GetSQLValueString($_POST['concepto2'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe2'], "int");
            }
		}
	}
	if (isset($_POST['concepto3']) && GetSQLValueString($_POST['concepto3'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			$insertSQL = sprintf("INSERT INTO detfac (tcomp, serie, ncomp, nreng,  codrem, concafac, descrip, neto, porciva, comcob, usuario) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       ...
                       GetSQLValueString(substr($_POST['descripcion3'],3,80), "text"),
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 4;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR GRABANDO R 4");
   			if (GetSQLValueString($_POST['concepto3'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe3'], "int");
            }
		}
	}
	if (isset($_POST['concepto4']) && GetSQLValueString($_POST['concepto4'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 5;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR EN LECTURA R 5");
   			if (GetSQLValueString($_POST['concepto4'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe4'], "int");
            }
		}
	}
	if (isset($_POST['concepto5']) && GetSQLValueString($_POST['concepto5'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			...
  			mysqli_select_db($amercado, $database_amercado);
  			$renglones = 6;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR EN LECTURA");
   			if (GetSQLValueString($_POST['concepto5'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe5'], "int");
            }
		}
	}
	if (isset($_POST['concepto6']) && GetSQLValueString($_POST['concepto6'], "int")!="NULL") {
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
  			...
  			$renglones = 7;
  			$Result1 = mysqli_query($amercado, $insertSQL) or die("ERROR EN LECTURA");
   			if (GetSQLValueString($_POST['concepto6'], "int") == 18) {
                $importe_tasa += GetSQLValueString($_POST['importe6'], "int");
            }
		}
	}
	if (isset($_POST['concepto7']) && GetSQLValueString($_POST['concepto7'], "int")!="NULL") {
	...
	if (isset($_POST['concepto']) && GetSQLValueString($_POST['concepto'], "int")!="NULL") {
  		...
  		$tcomp = $_POST['tcomp'];
  		$serie = $_POST['serie'];
  		$query_mascara = "SELECT * FROM series  WHERE  series.codnum='53'";
  		$mascara1 = mysqli_query($amercado, $query_mascara) or die("ERROR EN LECTURA SERIE");
		...
		if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "factura")) {
			...
			//$en_liquid = 0;
            if (isset($_POST['totneto'])) {
                $totneto21y0 = $_POST['totneto21'] + $_POST['totneto'];
                $totneto21y0 = $totneto21y0 - $importe_tasa;
            }
            else {
                $totneto21y0 = $_POST['totneto21'];
                $totneto21y0 = $totneto21y0 - $importe_tasa;
            }
  			$insertSQL = sprintf("INSERT INTO cabfac (tcomp, serie, ncomp, fecval, fecdoc, fecreg, cliente, fecvenc, estado, emitido, codrem, totbruto, totiva105, totiva21, totimp, totcomis, totneto105, totneto21, nrengs, nrodoc, en_liquid, CAE, CAEFchVto, Resultado, usuario, usuarioultmod) VALUES (%s, %s, %s, '$fecha_factura1','$fecha_factura1', '$fecha_factura1', %s, '$fecha_factura1', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, '$CAE', '$CAEFchVto', '$Resultado', %s, %s)",
                       NC_B2, //GetSQLValueString($_POST['tcomp'], "int"),
                       SERIE_B2, //GetSQLValueString($_POST['serie'], "int"),
                       $num_fac,
            ...
            // ACA REGRABO EL CBTE ASOCIADO Y LO PONGO EN ESTADO = "C"
            $query_leo_cbterel  = "SELECT * FROM cabfac WHERE serie = $ser AND ncomp = $ncomp_asoc";
            $leo_cbterel = mysqli_query($amercado, $query_leo_cbterel);
            $row_leo_cbterel = mysqli_fetch_assoc($leo_cbterel);
            if ($row_leo_cbterel["totbruto"] == GetSQLValueString($_POST['tot_general'], "double")) {
                mysqli_select_db($amercado, $database_amercado);
                $query_cbte_asoc = sprintf("UPDATE cabfac SET estado = %s WHERE  serie = %s  AND ncomp = %s",$est, $ser ,$ncomp_asoc);
                echo "- $query_cbte_asoc -";
	            $res_cbte_asoc = mysqli_query($amercado, $query_cbte_asoc);
            }

  			if (!empty($_POST['imprime'])) {
                $facnum = $num_fac;
                $tipcomp = NC_B2; // GetSQLValueString($_POST['tcomp'], "int");
                ...
                // Agregar el cambio que hice en el de pedidos, que lo envía a un php que es contenedor del factura_ok, así queda
                // el menu a la vista
	...
	$facturas_a = mysqli_query($amercado, $query_facturas_a) or die("ERROR EN LECTURA SERIE");
	...
	$facturas_b = mysqli_query($amercado, $query_facturas_b) or die("ERROR EN LECTURA SERIE");
...
$tipo_comprobante = mysqli_query($amercado, $query_tipo_comprobante) or die("ERROR EN LECTURA TIPCOMP");
$row_tipo_comprobante = mysqli_fetch_assoc($tipo_comprobante);
$totalRows_tipo_comprobante = mysqli_num_rows($tipo_comprobante);

mysqli_select_db($amercado, $database_amercado);
$query_cliente = "SELECT * FROM entidades WHERE (tipoent='2' OR tipoent='1') AND activo = '1' AND tipoiva != '1' AND tipoiva != '3' ORDER BY razsoc ASC";
$cliente = mysqli_query($amercado, $query_cliente) or die("ERROR EN LECTURA ENTIDAD");
...
$impuesto = mysqli_query($amercado, $query_impuesto) or die("ERROR EN LECTURA IMPUESTOS");
...
$iva_15_desc = "10,5 %"; //$row[2];	// Obtener el valor de la tercera columna (Ã­ndice 2)
$iva_15_porcen = 10.5; //$row[1];
$iva_0_porcen = 0;
?>
...
var selec = form.tipos.options;
    ...
    {
		factura.tcbterel.value = 6;
		factura.tcbterel_texto.value = "FACTURA B0002";
    ...
    if (selec[2].selected == true)
    {
		...
		factura.tcbterel.value = 7;
		factura.tcbterel_texto.value = "N DEB B0002";
...
var selec = form.tipos.options;
		...
		factura.serie_texto.value = "SERIE DE N. CRED B0002";
		factura.tcomp.value = 120;
...
function validarFormulario(form)
{
	...
	var monto9  = form.importe9.value; // Monto Décimo concepto
	...
	var porciva9  = form.tipoiva9.value / 100; // %IVA Décimo concepto
    ...
    if (monto.length!=0) {
		...
		if (eval(porciva)===0.21) {
            if (eval(comision) != 0) {
                var com = eval(monto+('*')+comision);
                var comis = eval(com+('/')+100.0);
            }
            else
                comis = 0;
	...
	if (monto1.length!=0) {
		...
		if (eval(porciva1)===0.21) {
           if (eval(comision1) != 0) {
               var com1 = eval(monto1+('*')+comision1);
                var comis1 = eval(com1+('/')+100.0);
...
<body>
<form id="factura" class="container" name="factura" method="POST" action="VAncB2">
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?=  $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?=  $TokenValue ?>"><!-- CSRF token value -->
  <table width="900" border="1" align="left" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
    <tr>
        <td width="900" colspan="3" ><div align="center"><img src="images/not_deb_aut.gif" width="330" height="30" /></div></td>
    </tr>
    <tr>
        <td colspan="2" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellspacing="1" cellpadding="1">
        <tr>
            <td width="13%" height="20" bgcolor="#FFFFFF"><span class="ewTableHeader">Tipo de Comprobante</span></td>
            <td width="37%"><select name="tipos" onchange="agregarOpciones(this.form)">
                                          <option value="120">NOTA DE CREDITO B0002</option>
            </select>
            <input name="tcomp" id="tcomp"  type="hidden" />
            </td>
           
            <td width="16%" class="ewTableHeader">Serie</td>
            <td width="34%"><input name="serie_texto" type="text" value="SERIE DE N CRED B0002" size="25" />
        ...
        <tr>
            ...
            <td width="34%"><div class="input-container">
        ...
        <tr>
            <td width="50%" height="57" bgcolor="#FFFFFF">&nbsp;<span class="ewTableHeader">No afecta Liquidacion</span></td>
        ...
        <td width="20%"><select name="tcbterel2" onchange="agregarOpciones2(this.form)">
                              <option value="6">FACTURA B0002</option>
							  <?php  if($_SESSION['id'] == 1 || $_SESSION['id'] == 49 || $_SESSION['id'] == 58)
                              echo "<option value='7'>N DEB B0002</option>";
                              ?>       
                           </select>
        ...
        <tr>
            ...
            <tr>
           	    <td width="210" background="images/fonod_lote.jpg" class="ewTableHeader">
           	    <div  align="center">CONCEPTO</div></td>
			    <td width="50" background="images/fonod_lote.jpg" class="ewTableHeader">
                <div  align="center">   % IVA   </div></td>
			    <td width="359" background="images/fonod_lote.jpg" class="ewTableHeader">
                <div align="center">DESCRIPCION</div></td>
	   		    <td width="130" background="images/fonod_lote.jpg" class="ewTableHeader">
                <div  align="center">COMISION</div></td>
          	    <td width="203" background="images/fonod_lote.jpg" class="ewTableHeader">
 		    ...
 		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="descripcion" type="text" class="phpmaker" id="descripcion" size="75" />  </td>
          	    <td bgcolor="#FFFFFF"><input name="comision" type="text" class="phpmaker" id="comision" size="10" />  </td>
          	    <td bgcolor="#FFFFFF"><input name="importe" type="text" id="importe"  required="required" onchange="validarFormulario(this.form)" size="20"   /></td>
		    ...
		    <tr>
    		    ...
    		    <td bgcolor="#FFFFFF"><input name="importe1" type="text" id="importe1" onchange="validarFormulario(this.form)"  size="20"  /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva2" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe2" type="text" id="importe2" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
		        ...
		        <td bgcolor="#FFFFFF"><input name="tipoiva3" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe3" type="text" id="importe3" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
                ...
                <td bgcolor="#FFFFFF"><input name="comision4" type="text" id="comision4" size="10" /></td> 
          	    <td bgcolor="#FFFFFF"><input name="importe4" type="text" id="importe4" onchange="validarFormulario(this.form)"size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva5" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe5" type="text" id="importe5" onchange="validarFormulario(this.form)"size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva6" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="descripcion6" type="text" class="phpmaker" id="descripcion6" size="75" /></td>
		   	    ...
		   	    <td bgcolor="#FFFFFF"><input name="importe6" type="text" id="importe6" onchange="validarFormulario(this.form)"size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="descripcion7" type="text" class="phpmaker" id="descripcion7" size="75" /></td>
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe7" type="text" id="importe7" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva8" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe8" type="text" id="importe8" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva9" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe9" type="text" id="importe9" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva10" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe10" type="text" id="importe10" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva11" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe11" type="text" id="importe11" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva12" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe12" type="text" id="importe12" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva13" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe13" type="text" id="importe13" onchange="validarFormulario(this.form)" size="20" /></td>
		    ...
		    <tr>
			    ...
			    <td bgcolor="#FFFFFF"><input name="tipoiva14" type="text" size="10" onchange="getprov(this.form)">
          	    ...
          	    <td bgcolor="#FFFFFF"><input name="importe14" type="text" id="importe14" onchange="validarFormulario(this.form)" size="20" /></td>
