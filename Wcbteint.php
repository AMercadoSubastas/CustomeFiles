	...
	if (isset($_POST['descripcion']) && GetSQLValueString($_POST['descripcion'], "text")!="NULL") {
	   ...
	   $mascara = "X0001";
		...
		if (!empty($_POST['imprime'])) {
			...
			echo 'window.location.href="rp_facncint.php?ftcomp=' . $tipcomp . '&fserie=' . $numserie . '&fncomp=' . $num_fac . '";';
			echo '</script>';
 	...
 	// alertaError()
  	...
  	if (tipo_comprobante=="" || total=="" || serie_num=="" || fecha_factura=="" ) {
		 ...
		 if (fecha_factura1=="") {
  		...
  		alertaError("Faltan los siguientes datos :\n"+error);
		...
		function setFieldFromCookie(fieldId) {
   		...
   		if( ckUtil.cookieExists() )	{
			//alertaError("SetFieldFromCookie.\n");
	  		...
	  		if( ckUtil.cookieExists() )	{
				//alertaError("Los datos fueron guardados en una cookie.\n");
				//     f.id_delete.disabled = false;
	  		}
	  		else {
				//alertaError("No hay cookie guardada primero agregue datos.\n" )
...
function  valor_prueba(form) {
		...
		//   alertaError("Impuesto 0: "+impuesto);
    	}

    	if (factura.impuesto[1].checked==true) {
         	var impuesto = (factura.impuesto[1].value)/100;
    		//     alertaError("Impuesto 1: "+impuesto);
    	}
    	//   alertaError("Impuesto : "+impuesto);
        ...
        //alertaError("Impuesto1 : "+impuesto1);
    	...
    	if (factura.impuesto2[1].checked==true) {
      	...
      	//   alertaError("Impuesto2 : "+impuesto2);  
...
function validarFormulario(form)
{
	...
	if (monto.length!=0) {
		//alertaError("ENTRO EN CONCEPTO 1");
		if (porciva===0) {
			//alertaError("IVA 0 ");
...
<body>
<form id="factura" name="factura" method="POST" class="container" action="VWcbteint">
  ...
  <table width="900" height="890" border="0" align="left" cellpadding="1" cellspacing="1" bgcolor="#82BADD">
    ...
    <tr>
      <td colspan="2" valign="top" bgcolor="#82BADD"><table width="900" border="1" cellspacing="1" cellpadding="1">
        ...
        <tr>
          <td height="20" class="ewTableHeader">N° Comprobante </td>
...
?>
			...
			<td bgcolor="#82BADD"><input name="tipoiva" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva1" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva2" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva3" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva4" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva5" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva6" type="text" size="10" onchange="getprov(this.form)">
		 </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva7" type="text" size="10" onchange="getprov(this.form)">
		 </td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva8" type="text" size="10" onchange="getprov(this.form)">
		 </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva9" type="text" size="10" onchange="getprov(this.form)">
		  </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva10" type="text" size="10" onchange="getprov(this.form)">
		 </td>
...
?>
			 ...
			 <td bgcolor="#82BADD"><input name="tipoiva11" type="text" size="10" onchange="getprov(this.form)">
		 </td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva12" type="text" size="10" onchange="getprov(this.form)">
		</td>
...
?>
			  ...
			  <td bgcolor="#82BADD"><input name="tipoiva13" type="text" size="10" onchange="getprov(this.form)">
		</td>
...
?>
		  ...
		  <td bgcolor="#82BADD"><input name="tipoiva14" type="text" size="10" onchange="getprov(this.form)">
	</td>
      ...
      <td height="36" colspan="3" bgcolor="#82BADD"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td colspan="3"  align="center">
			...
			<input type="submit" onclick="preguntame()";value="Grabar Cbte" id="evento_eliminar" name="evento_eliminar" />
